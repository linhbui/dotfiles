...
export ZSH=/Users/linhbui/.oh-my-zsh
...
alias cocoon="cd ~/Desktop/programs/cocooncam/"
alias wwc="cd ~/Desktop/programs/website/"
alias zshrc="vi ~/.zshrc"
alias vimrc="vi ~/.vimrc"
alias ackrc="vi ~/.ackrc"
alias sshe="be thor cloud:sshez"
alias gf="git fetch origin && git rebase origin/master"
alias ggpup="git push --set-upstream origin $(current_branch)"
...
alias stage="git push staging $(current_branch)"
alias glog="git log --pretty=format:'%Cgreen%ad%Creset %C(yellow)%h%Creset%C(yellow)%d%Creset %s %C(cyan)[%an]%Creset %Cred(%ar)%Creset' --date=short --graph"
